...
(async() => {
    ...
    console.log('New Maryland Apprenticeship Programs!', {aprog1, aprog2, aprog3}); 
    ...
    console.log('Maryland Apprentices!', {aNew1, aNew2, aNew3}); 
    ...
    console.log('Long Term Unemployed!', {longTermLocation}); 
    ...
    console.log('Service Participants in SNAP!', {SnapData2}); 
    // Create Table
...
window.prints = ["pop_chart_print", "empl_edu_gend_chart_print", "empl_race_ethn_chart_print", 
              "empl_vet_chart_print", "disabl_pov_chart_print", "tanf_chart_print", 
              "empl_status_chart_print", "snap_chart_print", "Landing",
              "Print3", "Print4", "PrintFive", "Print6", "Print17",
              "Print11", "Print18", "Print19", "Print20", "Print21"]
...
window.charts = ["pop_chart", "empl_edu_gend_chart", "empl_race_ethn_chart", "empl_vet_chart", 
              ...
              "Chart3", "Chart4", "ChartFive", "Chart6", "Chart17",
              "Chart11", "Chart18", "Chart19", "Chart20", "Chart21"]

window.collapsables = ["pop", "empl_edu_gend", "empl_race_ethn", "empl_vet", "disabl_pov", 
                       "tanf", "snap", "empl_status", "collapse1", "collapse2", "collapse3", 
                       "collapse4", "collapse5", "collapse15",
...
window.onload = function () {
	...
	document.querySelectorAll('[data-lbl]').forEach(el => {
		...
		el.addEventListener("click", function () {
			...
			// console.log(el.dataset.lbl);
			showall([el.dataset.lbl]);
			drawAll();
			hidePrint();
		})
	})
